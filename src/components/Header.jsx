...
const Header = () => {
    return (
        ...
        <div>
            ...
            <nav className="navbar navbar-expand-lg text-uppercase fs-6 p-3 border-bottom align-items-center">
                    ...
                    <div className="row justify-content-between align-items-center w-100">
                        <div className="col-auto">
                            ...
                            <path
                                ...
                                <span className="fw-lighter ms-3 logo">Creaciones Thanyi</span>
                            </a>
                        </div>
                        <div className="col-auto">
                            ...
                            <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                                ...
                                <div className="offcanvas-body">
                                    <ul className="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-4 pe-3">
                                        <li className="nav-item dropdown">
                                            <a className="nav-link active" href="index.html" id="" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Inicio</a>
                                        </li>


                                        <li className="nav-item dropdown">
                                            <a className="nav-link" href="#productos_principales" id="" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Productos</a>
                                        </li>

                                        <li className="nav-item dropdown">
                                            <a className="nav-link " href="#servicio" id="" data-bs-toggle="" aria-haspopup="true" aria-expanded="false">Servicio</a>
                                        </li>
